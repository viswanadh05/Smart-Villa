                            ...
                            <div class="row-fluid">
                                ...
                                <div class="span6">
                                    ...
                                    <div class="form-option user-profile-img-wrapper clearfix">
                                        ...
                                        <div class="profile-img-controls">
                                            ...
                                            <a id="select-profile-image" class="real-btn" href="javascript:;"><?php esc_html_e( 'Change','framework' ); ?> <i class="fa fa-picture-o"></i></a><br/>
                                            <a id="remove-profile-image" class="real-btn" href="#remove-profile-image"><?php esc_html_e( 'Remove','framework' ); ?> <i class="fa fa-trash-o"></i></a>

                                            <ul class="field-description">
                                                <li><?php esc_html_e( 'Profile image should have minimum width of 210px and minimum height of 210px.', 'framework' ); ?><br/></li>
                                    ...
                                    <div class="form-option">
                                        <label for="pass1"><?php esc_html_e( 'Password', 'framework' ); ?> <small>( <?php esc_html_e( 'Fill it only if you want to change your password', 'framework' ); ?> )</small></label>
                                ...
                                <div class="span6">
                                    ...
                                    <div class="form-option">
                                        ...
                                        <img src="<?php echo esc_attr( INSPIRY_DIR_URI ); ?>/images/ajax-loader.gif" id="form-loader" alt="Loading...">
                                    </div>
