<div class="form-option checkbox-option clearfix terms-field-wrapper">
	...
	?><label for="terms"><?php echo $terms_note; ?></label>
	<input id="terms" name="terms" type="checkbox" class="<?php echo $terms_class; ?>" title="<?php esc_html_e( 'Please check this option.', 'framework' ); ?>" <?php
