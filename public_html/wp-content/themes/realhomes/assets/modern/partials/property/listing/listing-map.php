...
if ( is_page_template( 'templates/template-search.php' ) || is_page_template( 'templates/template-search-sidebar.php' ) || is_page_template( 'templates/template-search-right-sidebar.php' ) ) {
	    ...
	    function initializePropertiesMap() {
	        ...
	        var mapOptions = {
				...
				streetViewControlOptions: {
					<?php if ( is_page_template( 'templates/template-search.php' ) ) { ?>
