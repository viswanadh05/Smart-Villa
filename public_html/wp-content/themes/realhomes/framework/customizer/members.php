...
if ( ! function_exists( 'inspiry_members_customizer' ) ) :
	function inspiry_members_customizer( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_control( 'theme_login_url', array(
			...
			'description' => __( 'Selecting Login and Register page above is enough and this setting is displayed for backward compatibility', 'framework' ),
			'type' => 'url',
			'section' => 'inspiry_members_login',
		) );
		...
		$wp_customize->add_control( 'theme_profile_url', array(
			...
			'description' => __( 'Selecting edit profile page above is enough and this setting is displayed for backward compatibility', 'framework' ),
			'type' => 'url',
			'section' => 'inspiry_members_profile',
		) );
		...
		$wp_customize->add_control( 'theme_submit_url', array(
			...
			'description' => __( 'Selecting submit property page above is enough and this setting is displayed for backward compatibility', 'framework' ),
			'type' => 'url',
			'section' => 'inspiry_members_submit',
		) );
		...
		$wp_customize->add_control( 'theme_my_properties_url', array(
			...
			'description' => __( 'Selecting my properties page above is enough and this setting is displayed for backward compatibility', 'framework' ),
			'type' => 'url',
			'section' => 'inspiry_members_properties',
		) );
		...
		$wp_customize->add_control( 'theme_favorites_url', array(
			...
			'description' => __( 'Selecting Favorite Properties page above is enough and this setting is displayed for backward compatibility', 'framework' ),
			'type' => 'url',
			'section' => 'inspiry_members_favorites',
		) );
