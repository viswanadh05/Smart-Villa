...
if ( ! function_exists( 'inspiry_home_features_title_render' ) ) {
	function inspiry_home_features_title_render() {
		if ( get_option( 'inspiry_home_features_title' ) && ( 'classic' === INSPIRY_DESIGN_VARIATION ) ) {
			echo esc_html( get_option( 'inspiry_home_features_title' ) );
		} elseif ( get_option( 'inspiry_home_features_title' ) && ( 'modern' === INSPIRY_DESIGN_VARIATION ) ) {
			$title = get_option( 'inspiry_home_features_title' );
