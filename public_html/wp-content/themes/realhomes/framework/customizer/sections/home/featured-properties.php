...
if ( ! function_exists( 'theme_featured_prop_title_render' ) ) {
	function theme_featured_prop_title_render() {
		if ( get_option( 'theme_featured_prop_title' ) && ( 'classic' === INSPIRY_DESIGN_VARIATION ) ) {
			echo esc_html( get_option( 'theme_featured_prop_title' ) );
		} elseif ( get_option( 'theme_featured_prop_title' ) && ( 'modern' === INSPIRY_DESIGN_VARIATION ) ) {
			$title = get_option( 'theme_featured_prop_title' );
